...
function Chatbot() {    
    ...
    function deleteMessage(index: number) {
        ...
        const updatedMessages = messages.filter((_, i) => i < index || i >= index + 2);
    ...
    const saveMessage = async (index: number, context: string) => {
        ...
        updatedMessages[index] = { ...updatedMessages[index], text: editMessageText };
        ...
        try {
            ...
            updatedMessages[index + 1] = { sender: 'bot', text: "I'm sorry, something went wrong. Please try again." };
            setMessages(updatedMessages);
        }
    };
            ...
            <div className='Chatbot-ui-container'>   
                ...
                {isChatbotOpen && (
                    <div className='Chatbot-ui'>
                        <div className='Chatbot-ui-header' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <div className='Chatbot-ui-heading'>
                            <img src={avaHeadshot} alt="Ava Chatbot headshot" style={{width:"60px"}} />
                            <h3>Hey👋, I'm Ava</h3>
                                ...
                                {messages.map((message, index) => (
                                    <div key={index}>
                                        ...
                                        >
                                            ...
                                            <div 
                                                className={index === editMode ? 'edit-message-container' : message.sender === 'user' ? 'user-message' : 'ava-response'}
                                                style={{ marginRight: '5px' }}
                                                onMouseEnter={() => message.sender === 'user' && setHoveredMessage(index)}
                                            >
                                                {index === editMode ? (
                                            ...
                                            {hoveredMessage === index && message.sender === 'user' && index !== editMode && (
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className='Chatbot-ui-input-box'>
                                    ...
                                    <textarea 
                                        ...
                                        onKeyDown={(e) => {
                                            if (e.key === 'Enter' && !e.shiftKey && newMessage.trim() !== '' && !isBotResponding) {
